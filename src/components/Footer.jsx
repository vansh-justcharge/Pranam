    ...
    <footer className="bg-gradient-to-b from-[#FFFFFF] to-[#BCC57140] text-center py-10 px-4 font-bricolage">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-8">
        <input
          ...
          className="px-6 py-2 rounded-md border bg-[#F7EDFF00] border-[#BCC571] w-96 focus:outline-none"
        />
        <button className="px-5 py-2 rounded-md bg-[#EFF1DD] border border-[#BCC571] text-black font-medium transition">
          Subscribe
        </button>
      </div>
